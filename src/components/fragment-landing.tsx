...
const cardTypes = [
  ...
  { name: "Relic", icon: Gem, role: "modify lines", className: "border-amber-200/40" },
      ...
      <div className="container grid gap-10 lg:grid-cols-[0.78fr_1fr] lg:items-center">
        <div className="reveal">
          ...
          <p className="mt-6 max-w-2xl text-base leading-8 text-slate-300">
            ...
            Quick Actions, companions, and Energy lines you can bring into combat.
          </p>
          <div className="mt-8 grid gap-3 sm:grid-cols-3">
            {[
              ["Hero", "sets the plan"],
              ["Deck", "executes the line"],
      ...
      <div className="grid gap-4 md:grid-cols-[0.72fr_1fr]">
        ...
        <div className="grid gap-3">
          {[
            ...
            ["Base Attack", "3s / 2 dmg", "physical line"],
...
function GameplaySystems() {
  return (
    <section id="systems" className="relative py-24">
      ...
      <div className="absolute inset-x-0 top-1/2 h-px bg-gradient-to-r from-transparent via-red-300/25 to-transparent" />
  ...
  return (
    <main className="min-h-screen overflow-hidden">
      ...
      <section id="hero" className="relative isolate flex min-h-screen items-center pt-24">
        ...
        <div className="absolute left-1/2 top-28 h-px w-[75vw] -translate-x-1/2 bg-gradient-to-r from-transparent via-cyan-100/40 to-transparent" />
      ...
      <section id="early-access" className="container pb-20 pt-16">
        <div className="relative overflow-hidden border border-cyan-100/20 p-8 shadow-fracture-cyan sm:p-14 lg:min-h-[520px]">
          <Image
          ...
          <Image
            ...
            width={1500}
            height={1000}
            className="pointer-events-none absolute bottom-[-10%] right-[-12%] z-0 hidden h-[96%] w-auto opacity-90 drop-shadow-[0_24px_70px_rgba(240,196,92,0.16)] lg:block"
          />
